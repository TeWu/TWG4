...
ActiveRecord::Schema.define(version: 20160916152626) do
  ...
  create_table "photos_in_albums", force: :cascade do |t|
    ...
    t.index ["photo_id", "album_id"], name: "index_photos_in_albums_on_photo_id_and_album_id", unique: true, using: :btree
